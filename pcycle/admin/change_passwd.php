...
<?php
  ...
  {//begin of if($submit).
	    ...
	    $passwd = $_POST['passwd'];
		$result = mysql_query("UPDATE members SET password =password('$passwd') WHERE username='admin'");
...
<tr><td colspan="2" align="center" style="font-size:20px">Update Password</td></tr>  <tr>
